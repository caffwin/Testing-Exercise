...
class PartyTestsRsvps(unittest.TestCase):
    """Tests for my party site."""
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn(b"<td>Snakes and Ladders</td>", result.data)
        self.assertIn(b"<td>Ticket to Ride</td>", result.data)
